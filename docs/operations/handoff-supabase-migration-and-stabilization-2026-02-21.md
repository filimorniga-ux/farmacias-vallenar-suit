...
- Correr *smoke test* sobre `LocationSwitcher` (Dropdown superior de sucursales) y validar si los textos se solapan o recortan los botones de acción (`WMSBottomTabBar`).
