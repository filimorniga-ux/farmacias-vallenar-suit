...
* **Database:** PostgreSQL (Supabase Production / Tiger Cloud).
* **Infrastructure:** Hybrid Cloud (Vercel for DX + DigitalOcean Docker for Scale).
...
* [ ] **Migración a DigitalOcean (Scale Phase):** Preparar entorno de producción con Docker para manejar +40 empleados y múltiples sucursales físicas.
