...
import { X, Barcode, Package, CheckCircle, AlertTriangle, Save, Volume2, Camera } from 'lucide-react';
                        ...
                        <div className="w-full max-w-2xl relative group">
                            ...
                            <div className="flex gap-3">
                                <input
                                    ...
                                    className="flex-1 bg-slate-800 border-2 border-slate-600 focus:border-cyan-500 text-white text-3xl font-mono text-center py-6 rounded-2xl shadow-2xl outline-none transition-all placeholder:text-slate-600"
                                ...
                                <button
                                    ...
                                    className="px-6 py-4 bg-cyan-600 hover:bg-cyan-500 text-white rounded-2xl shadow-lg transition-all flex items-center gap-2"
