...
const ContextSelectionPage: React.FC = () => {
    ...
    return (
        <div data-testid="public-context-page" className="min-h-dvh bg-slate-50 flex flex-col items-center justify-center p-4 sm:p-6 pt-safe pb-safe relative overflow-hidden">
            ...
            <div className="relative z-10 w-full max-w-5xl">
                ...
                <header className="mb-8 md:mb-12 text-center">
                    <h1 className="text-3xl md:text-6xl font-extrabold text-slate-900 tracking-tight mb-3 text-balance">
                        Farmacias <span className="text-sky-600">Vallenar</span> Suit
                    </h1>
                    <p className="text-slate-500 font-medium text-base md:text-lg tracking-wide">Sistema ERP Clínico Integral</p>
                </header>
                        ...
                        <div className="flex flex-col items-center justify-center p-12 text-center text-red-500 bg-red-50 rounded-2xl border border-red-100">
                            ...
                            <div className="mt-4 flex flex-wrap justify-center gap-2">
                                <button
                                    ...
                                    className="min-h-11 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-red-600 hover:bg-red-700 text-white font-semibold transition-colors"
                                >
                                    <RefreshCw size={16} />
                                    Reintentar
                                </button>
                                {fallbackLocation && (
                                    <button
                                        ...
                                        className="min-h-11 inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-white border border-red-200 text-red-600 hover:bg-red-100 font-semibold transition-colors"
                                    >
                            ...
                            {publicLocations.map(loc => {
                                ...
                                return (
                                    <button
                                        ...
                                        className={`group relative min-h-44 bg-white border ${isPreferred ? 'border-sky-500 shadow-xl shadow-sky-900/10' : 'border-slate-100'} hover:border-sky-400 rounded-2xl p-6 text-left transition-[border-color,box-shadow,transform] duration-300 hover:scale-[1.02] hover:shadow-2xl hover:shadow-sky-900/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-sky-500 focus-visible:ring-offset-2`}
                                    >
