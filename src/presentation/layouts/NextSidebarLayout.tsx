...
const NextSidebarLayout = ({ children }: { children: React.ReactNode }) => {
    ...
    const menuItems = [
        ...
        { icon: ShoppingCart, label: 'Punto de Venta', path: '/pos', roles: ['CASHIER', 'QF', 'MANAGER', 'ADMIN', 'GERENTE_GENERAL'], color: 'emerald' as AppThemeColor },
        { icon: Package, label: 'Inventario', path: '/inventory', roles: ['WAREHOUSE', 'WAREHOUSE_CHIEF', 'MANAGER', 'QF', 'ADMIN', 'GERENTE_GENERAL'], color: 'cyan' as AppThemeColor },
        { icon: Truck, label: 'Operaciones WMS', path: '/warehouse', roles: ['WAREHOUSE', 'WAREHOUSE_CHIEF', 'MANAGER', 'QF', 'ADMIN', 'GERENTE_GENERAL', 'CASHIER'], color: 'amber' as AppThemeColor },
        { icon: Building2, label: 'Proveedores', path: '/suppliers', roles: ['MANAGER', 'QF', 'WAREHOUSE', 'WAREHOUSE_CHIEF', 'ADMIN', 'GERENTE_GENERAL'], color: 'blue' as AppThemeColor },
...
export default NextSidebarLayout;
